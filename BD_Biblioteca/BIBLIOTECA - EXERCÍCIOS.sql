...
#1- UTILIZANDO O RECURSO "IN", SELECIONAR TODAS AS INFORMACOES DOS 
#AUTORES "JK ROWLING" E "STEPHAN KING":
...
#3- EXIBIR QUAL CATEGORIA DE LIVROS, NAO TEM NENHUM LIVRO VINICULADO 
#A ELA
SELECT * FROM tbl_livros;
SELECT * FROM tbl_categoria;
SELECT nome_categoria FROM tbl_categoria WHERE
